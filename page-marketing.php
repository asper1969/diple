...
<div class="packages">
    <div class="wrapper">
        <div class="package yandex active">
            <div class="container">
                <h2 class="title">
                    <strong>Профессионально настраиваем и ведем</strong>
                    контекстную рекламу в Яндекс и Google
                </h2>
...
<div class="calculators">
    ...
    <div class="wrapper">
        ...
        <div class="package google">
            <div class="img">
                <img src="<?php echo get_template_directory_uri(); ?>/prod/images/content/google-glitch.jpg" alt="">
            </div>
            <div class="form-wrapper">
                <form class="calc">
                    <div class="fieldset">
        ...
        <div class="package yandex">
            ...
            <div class="presentation banner">
                ...
                <div class="slide slide-2" data-index="2">
                    ...
                    <ul class="icons">
                        <li class="icon">
                            <span>Подбираем качественные <br>
                            графические изображения</span>
                        </li>
                        <li class="icon">
                            <span>Помечаем объявления UTM  и подключаем <br>
                            метрику, для последующего анализа</span>
                        </li>
                        <li class="icon"><span>Разрабатываем стратегию <br>
                            показа, опираясь на медиаплан</span></li>
                        <li class="icon"><span>Пишем тизерный, <br>
                            развернутый, классический текст</span></li>
                        <li class="icon"><span>Настраиваем таргетинг <br>
                            под целевую аудиторию</span></li>
                    </ul>
                </div>
                <div class="slide slide-3" data-index="3">
